...
# 6s ~ 6.5s
# swarm.parallel(lambda i, tello: tello.flip('b'))
...
# 14s ~ 20s
locate = [(0, 170, 300, 35), (0, 290, 300, 45), (0, 410, 300, 60), (0, 500, 300, 78), (0, 500, 300, 96), (0, 500, 300, 87), (0, 480, 300, 69), (0, 360, 300, 52), (0, 240, 300, 39), (0, 120, 300, 33)]
swarm.parallel(lambda i, tello: tello.go_xyz_speed(locate[i][0], locate[i][1], locate[i][2], locate[i][3]))
...
time.sleep(0.33)
swarm.parallel(lambda i, tello: tello.flip('l') if i == 8 else tello.go(0, 0, 0, 0))
time.sleep(0.33)
swarm.parallel(lambda i, tello: tello.flip('l') if i == 7 else tello.go(0, 0, 0, 0))
time.sleep(0.33)
swarm.parallel(lambda i, tello: tello.flip('l') if i == 6 else tello.go(0, 0, 0, 0))
time.sleep(0.33)
